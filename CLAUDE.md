...
- [Real-World Transit Practice](docs/real-world-transit-practice.md) — how cities actually plan routes & adapt to events (World Cup); grounds the sim, event-shocks, and equity logic.
